...
export const Skills = () => {
  ...
  const categoryIcons = {
    'Languages': Code,
    'Backend & Enterprise': Server,
    'Core Concepts & Engineering': Cpu,
    'Web & Frontend': Layout,
    ...
    <section id="skills" className="py-20 relative bg-slate-100/50 dark:bg-slate-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <div className="w-16 h-1 bg-cyan-500 rounded-full mt-3 mb-6" />
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl text-sm sm:text-base">
            Engineered around Core Java and the Spring Boot ecosystem, with full-stack capability across modern reactive web apps and enterprise database architectures.
          </p>
        </div>
                    ...
                    {group.skills.map((skill, sIdx) => (
                      <span
                        ...
                        className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-mono transition-all ${
                          skill.highlight
                            ? 'bg-cyan-50 dark:bg-cyan-950/70 text-cyan-700 dark:text-cyan-300 border border-cyan-300 dark:border-cyan-800/80 font-medium'
