      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {education.map((item, idx) => (
            <div
              key={idx}
              className="glass-card p-6 sm:p-7 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:shadow-lg transition-all border border-slate-200/80 dark:border-slate-800"
            >
              ...
              <div className="flex sm:flex-col sm:items-end justify-between items-center gap-1.5 shrink-0 pt-3 sm:pt-0 border-t sm:border-t-0 border-slate-200 dark:border-slate-800">
                <div className="text-base sm:text-lg font-bold font-mono text-cyan-600 dark:text-cyan-400">
                  {item.grade}
                </div>
